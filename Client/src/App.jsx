...
const App = () => {
  return (
    <BrowserRouter>
      <Routes>
        <Route path="/applicantPool/:jobId" element={<ApplicantPool />} />
        ...
        <Route
          path="/technicalPracticeSimulation"
          element={<TechnicalPracticeSimulation />}
        />
        <Route
          path="/nonTechnicalPracticeSimulation"
          element={<NonTechnicalPracticeSimulation />}
        />
